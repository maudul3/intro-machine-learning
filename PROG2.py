...
def calculate_probability(test_row, mean_row, stdev_row, class_prob):
    '''Calculate probability for a sample give mean, stdev, and probability for a given class'''
...
def true_pos(tup):
    '''Returns 1 if predicted value is spam and true value is spam else 0'''
...
def true_neg(tup):
    '''Returns 1 if predicted value is not-spam and true value is not-spam else 0'''
...
def false_pos(tup):
    '''Returns 1 if predicted value is spam and true value is not-spam else 0'''
    if (tup[0] != tup[1]) and tup[1] == 0:
        return 1
    else:
        return 0
...
def false_neg(tup):
    '''Returns 1 if predicted value is not-spam and true value is spam else 0'''
    if (tup[0] != tup[1]) and tup[1] == 1:
        return 1
    else:
        return 0
